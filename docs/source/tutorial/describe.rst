...
If none of this happens during the deadline period, Kubernetes considers the rollout stuck.
...
When something is changed in the Deployment spec, Kubernetes creates a new ReplicaSet with the updated Pod template.
