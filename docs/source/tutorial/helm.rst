...
A Chart is a collection of files used to deploy an application. There is a good starting repo available at `https://github.com/
kubernetes/charts/tree/master/stable`, provided by vendors, or you can create your own. Search the current Charts in
the Helm Hub or an instance of Monocular for available stable databases. Repositories change often, so the following output
